...
/** @typedef {typeof import("./ChunkGroup.js")} ChunkGroup */
/** @typedef {typeof import("./Entrypoint.js")} Entrypoint */

/**
 * Compare two modules based on their ids
 * @param {Module} a
 * @param {Module} b
 */
const byId = (a, b) => {
...
/**
 * Compare two modules based on their id or identifiers
 * @param {Module} a
 * @param {Module} b
 */
...
/**
 * Compare two modules based on their index or identifiers
 * @param {Module} a
 * @param {Module} b
 */
...
/**
 * Compare two modules based on their name or hash
 * @param {Module} a
 * @param {Module} b
 */
...
/** @typedef {*} Variable TODO */
/**
 * TODO: description
 * @param {Variable[]} variables
 * @param {(var: Variable) => void} fn
 */
...
/**
 * Invoke an array of items with a callback function
 * @param {any[]} arr
 * @param {Function} fn
 */
...
/**
 * Add all of iterable items to a Set
 * @param {Set} set
 * @param {IterableIterator} otherSet
 */
...
class Compilation extends Tapable {
	constructor(compiler) {
		...
		this.chunks = [];
		/** @private @type {ChunkGroup[]} */
		this.chunkGroups = [];
		this.namedChunkGroups = new Map();
		this.namedChunks = new Map();
		this.modules = [];
		this._modules = new Map();
		/** @private @type {{[cacheName: string]: Module} | null} */
		this.cache = null;
		this.records = null;
